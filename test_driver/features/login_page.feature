Feature: Main Page
  ...
  Scenario: Checking Login Page
    ...
    And I tap "sign-in-screen-reset-password-button" button
    And Then I expect the button 'Submit' to be present
#
...
#    When I fill the "sign-in-screen-email-input-field" field with "bob.gmail.com"
#    And  I tap the label that contains the text "Sign in"
#    And  I expect the text "Please enter valid email address" to be present
#    Then I tap the button with tooltip "Back"
#
#    When I tap the label that contains the text "Sign in"
#    And  I fill the "sign-in-screen-email-input-field" field with "bob@gmail"
#    And  I tap the label that contains the text "Sign in"
#    And  I expect the text "Please enter valid email address" to be present
#    Then I tap the button with tooltip "Back"
#
#    When I tap the label that contains the text "Sign in"
#    And  I fill the "sign-in-screen-email-input-field" field with "Bob@gmail.com"
#    And  I tap the label that contains the text "Sign in"
...
#    When I tap the label that contains the text "Sign in"
#    And I fill the "login-screen-password-input-field" field with "pass"
#    And  I tap the label that contains the text "Sign in"
...
#
#    When I tap the label that contains the text "Sign in"
#    And I fill the "login-screen-password-input-field" field with "Password"
#    And  I tap the label that contains the text "Sign in"
#    And I expect the text "Please enter valid password" to be present
#    Then I tap the button with tooltip "Back"
#
#    When I tap the label that contains the text "Sign in"
#    And  I fill the "login-screen-password-input-field" field with "Password1"
#    And  I tap the label that contains the text "Sign in"
#    And I expect the text "Please enter valid password" to be present
#    Then I tap the button with tooltip "Back"
#
